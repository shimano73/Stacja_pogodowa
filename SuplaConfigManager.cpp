...
double ConfigOption::getValueDouble(){
  return atof(_value);
}
...
SuplaConfigManager::SuplaConfigManager() {
  if (SPIFFS.begin()) {
    ...
    // this->addKey(KEY_TEST, "0", 2000, 3); //dodanie parametru do wersji 2 configa
      ...
      this->addKey(KEY_ANEMOMETR_FACTORY,"0",8,0);
      this->addKey(KEY_PLUVIOMETER_FACTORY,"0",6,0);
      this->addKey(KEY_PLUVIOMETER_TIME_H,"0",2,0);     
      this->addKey(KEY_PLUVIOMETER_TIME_M,"0",2,0);      
      this->addKey(KEY_SMOG_SENSOR_STATE,"0",1,0);
      this->addKey(KEY_SMOG_SENSOR_PERIOD,"0",2,0);
      this->addKey(KEY_SMOG_SENSOR_PM25,"0",3,0);
      this->addKey(KEY_SMOG_SENSOR_PM10,"0",3,0);  
      this->addKey(KEY_AQI_ECO_STATE,"0",1,0);
      this->addKey(KEY_AQI_ECO_HOST,"0",15,0);
      this->addKey(KEY_AQI_ECO_PATH,"0",50,0); // /update/6b355fd4b0342022c5191053adc62ecf
      this->addKey(KEY_AQI_ECO_STATUS,"0",15,0);      
      ...
      this->addKey(KEY_AIR_MONITOR_STATUS,"0",15,0);
