...
enum _key
{
  ...
  KEY_PLUVIOMETER_FACTORY,
  KEY_PLUVIOMETER_TIME_H,
  KEY_PLUVIOMETER_TIME_M,  
  KEY_SMOG_SENSOR_STATE,
  KEY_SMOG_SENSOR_PERIOD,
  KEY_SMOG_SENSOR_PM25,
  KEY_SMOG_SENSOR_PM10,  
  KEY_AQI_ECO_STATE,
  KEY_AQI_ECO_HOST,
  KEY_AQI_ECO_PATH,
  KEY_AQI_ECO_STATUS,
  KEY_AIR_MONITOR_STATE,
  KEY_AIR_MONITOR_SERVER,
  KEY_AIR_MONITOR_LATITUDE,
  KEY_AIR_MONITOR_LONGITUDE,
  KEY_AIR_MONITOR_STATUS,
  // KEY_TEST,
...
enum _function
{
  ...
  FUNCTION_SMOG_SENSOR_RX,
  FUNCTION_SMOG_SENSOR_TX,
  FUNCTION_SMOG_SENSOR_PERIOD,
  FUNCTION_ANEMOMETR,
  FUNCTION_PLUVIOMETER,
  FUNCTION_AQI_ECO_STATE,
  FUNCTION_AQI_ECO_HOST,
  FUNCTION_AQI_ECO_PATH
