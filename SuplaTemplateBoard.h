...
#define BOARD_WEATHER_STATION  27
...
const char WEATHER_STATION[] PROGMEM = "Weather station";
...
const char* const BOARD_P[MAX_MODULE] PROGMEM = {
    ...
    YUNTONG_SMART,  GOSUNG_SP111,  DIMMER_LUKASZH, H801,      SHELLY_PLUG_S, SONOFF_MINI,      MINITIGER_1CH,    MINITIGER_2CH, MINITIGER_3CH, WEATHER_STATION };
